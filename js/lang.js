(function(){
  const dict = {
    es: { home:"Inicio", premium:"Premium", subs:"Suscripción", videos:"Vídeos",
          welcome:"Bienvenido a BeachGirl", latest:"Últimas fotos", premiumTitle:"Fotos Premium", videosTitle:"Vídeos Premium" },
    en: { home:"Home", premium:"Premium", subs:"Subscription", videos:"Videos",
          welcome:"Welcome to BeachGirl", latest:"Latest Photos", premiumTitle:"Premium Photos", videosTitle:"Premium Videos" },
    fr: { home:"Accueil", premium:"Premium", subs:"Abonnement", videos:"Vidéos",
          welcome:"Bienvenue à BeachGirl", latest:"Dernières photos", premiumTitle:"Photos Premium", videosTitle:"Vidéos Premium" },
    de: { home:"Start", premium:"Premium", subs:"Abo", videos:"Videos",
          welcome:"Willkommen bei BeachGirl", latest:"Neueste Fotos", premiumTitle:"Premium-Fotos", videosTitle:"Premium-Videos" },
    it: { home:"Home", premium:"Premium", subs:"Abbonamento", videos:"Video",
          welcome:"Benvenuto a BeachGirl", latest:"Ultime foto", premiumTitle:"Foto Premium", videosTitle:"Video Premium" }
  };
